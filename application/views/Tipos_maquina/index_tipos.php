<div class="container-fluid">
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="  tab-pane fade show active" id="lista" role="tabpanel" aria-labelledby="lista-tab">
            ...
            <div class="row d-flex justify-content-center ">
                <div class="table-responsive-sm col-lg-10">
                    <table id="Tipo" class="display table table-hover select-filter" style="width: 100%;">
        ...
        <!-- Tab de formulario -->
        <div class="tab-pane fade" id="formulario" role="tabpanel" aria-labelledby="formulario-tab"><?= $form_tipo_maquina ?></div>
    </div>
    <div style="display: none;" id="clickedTab"></div>

    <!-- Mantenimiento de maquinas -->
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/scripts/Tipos/crud_tipos.js"></script>